...
class MYPDF extends TCPDF {
    ...
    public function Header() {
        // Logo
        $image_file = K_PATH_IMAGES.'auf.jpg';
        $this->Image($image_file, 11, 11, 11, '', 'JPG', '', 'T', false, 300, '', false, false, 0, false, false, false);
        // Set font
        $this->SetFont('times', 'B', 20);
        // Title
        $this->Cell(0, 15, 'Brief History of the University', 0, false, 'C', 0, '', 0, false, 'M', 'M');
    }
...
$pdf->SetTitle('Task #2 - Brief History of Angeles University Foundation');
